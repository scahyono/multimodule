<cfcomponent output="false" displayname="Multi Module">
        ...
        <cffunction name="$buildModulesCache" returntype="array" hint="search for modules under modules folder if developer did not specify set(multiModulePaths) in settings.cfm">
                <cfscript>
                        var loc = StructNew();
